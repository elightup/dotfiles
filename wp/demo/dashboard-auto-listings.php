...
add_action( 'welcome_panel', function () {
	...
	<div class="welcome-panel-content">
		<div class="welcome-panel-header">
			...
			<h2>Welcome to WP Auto Listings Demo!</h2>
			<p>On this website, you'll find how to use Auto Listings and all of its premium extensions.</p>
			<p>If you have any questions or feedback, please <a href="https://wpautolistings.com/support/" href="_blank">contact us</a>. Have a great time with Auto Listings!</p>
		</div>
		<div class="welcome-panel-column-container">
			<div class="welcome-panel-column">
				...
				<div>
					...
					<p>Start to explore <a href="/wp-admin/edit.php?post_type=auto-listing&page=auto-listings">Auto Listings settings</a> to understant what features the plugin offers. Most of the settings are set up automatically for you.</p>
					<p>Start <a href="/wp-admin/post.php?post=1558&action=edit">editing a listing</a> to see how the the plugin works. Don't forget to <a href="/listing/2017-ex-2dr-coupe-front-wheel-drive/" target="_blank">view it on the front end</a> to see the it in action.</a>
				</div>
			</div>
			<div class="welcome-panel-column">
				<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
				...
				<div>
					<h3>Experience</h3>
					<p>Below are some things you can try with Auto Listings:</p>
					<p>1. View the list of <a href="/wp-admin/edit.php?post_type=listing-enquiry">enquiries</a> that people submit when they're interested in some listings.</p>
					<p>2. Create a <a href="/wp-admin/edit.php?post_type=auto-listings-search">custom search form</a>.</p>
					<p>3. Explore <a href="/wp-admin/edit.php?post_type=auto-listing&page=auto-listings">the plugin settings</a> to see all the things that the plugin offers.</p>
				</div>
			</div>
			<div class="welcome-panel-column">
				<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
				...
				<div>
					...
					<p><a href="/wp-admin/edit.php?post_type=auto-package">Create a custom package</a> for users to submit listings from the front end.</p>
					<p><a href="/wp-admin/edit.php?post_type=dealer">Manage dealers</a> and edit their details.</a>
				</div>
			</div>
		</div>
	</div>
